...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 07, 2024 lúc 02:23 PM
...
INSERT INTO `danhgiasanpham` (`MaDG`, `MaSP`, `MaUser`, `TieuDe`, `NoiDung`, `NgayDanhGia`) VALUES
(1, 0, '<br />\r\n<b>Warning</b>:  Undefined variable $maUser in <b>C:\\xampp\\htdocs\\Nhom6_SneakersShop\\DanhGiaSanPham.php</b> on line <b>66</b><br />\r\n', '1', 'aaa', '2024-06-07 09:51:06'),
(2, 182, '2', 'đẹp', 'okela', '2024-06-07 09:51:06'),
(3, 182, '2', 'đẹp', 'eee', '2024-06-07 09:51:06'),
(4, 182, '2', 'aaa', 'ffff', '2024-06-07 09:51:06'),
(5, 182, '2', 'rrrr', 'hihi', '2024-06-07 09:51:06'),
(6, 182, '2', 'rrrr', 'hihi', '2024-06-07 09:51:06');
...
(22, 2, '2024-06-07 00:00:00', 'TienMat', 5500000, 0, 5500000, '', 1),
(23, 2, '2024-06-07 00:00:00', 'TienMat', 3100000, 0, 3100000, '', 1),
(24, 2, '2024-06-07 00:00:00', 'TienMat', 5500000, 0, 5500000, '', 1),
(25, 2, '2024-06-07 00:00:00', 'TienMat', 16500000, 0, 16500000, '', 1);
...
(1, 1, 'Nike Air Force 107 LV8 ‘Split – Black Phantom’ FD2592-002', 1000000, 'aaaa'),
...
(9, 3, 'Vans Knu-Skool ‘Black White’ VN0009QC6BT\'', 2205000, 'Trong vũ trụ thời trang đa dạng và phong phú, Vans Knu Skool không chỉ đơn thuần là một sản phẩm, mà còn là một tác phẩm nghệ thuật đầy bất ngờ. Đôi giày này đã nhanh chóng ghi dấu ấn mạnh mẽ với sự sáng tạo tuyệt vời và sự kết hợp hoàn hảo giữa phong cách và tiện nghi. Với sắc đen huyền bí tạo nên sự lôi cuốn và viền trắng tinh tế, đôi giày này chắc chắn sẽ là điểm nhấn hoàn hảo cho bất kỳ bộ trang phục nào, đem đến sự tinh tế và sự phá cách cho mọi phong cách thời trang.'),
(10, 7, 'Converse x DRKSHDW TURBODRK Chuck 70', 7900000, 'Rick Owens và Converse không phải lúc nào cũng có mối quan hệ công việc, nhưng cả hai tổ chức đã hợp tác trong vài năm qua để mang DRKSHDW TURBODRK Chuck 70 đến với công chúng. Gần đây, hình bóng tiên phong nổi lên với họa tiết ngựa vằn.Chất liệu lông bao phủ phần trên, ngoại trừ ngón chân. Các chi tiết màu đen tương phản xuất hiện dọc theo các mặt cắt và cột sống, với đồng nhãn hiệu trên lưỡi thuôn dài, miếng dán Một Ngôi sao ở giữa và biển số xe cũng chọn tông màu tối. Dưới chân, bộ phận duy n'),
(11, 8, 'MLB Chunky Wide Los Angeles ‘Pink’ 3ASXCCW3N-07PKS', 4100000, 'Mua Giày MLB Chunky Wide Los Angeles ‘Pink’ 3ASXCCW3N-07PKS chính hãng 100% có sẵn tại Authentic Shoes. Giao hàng miễn phí trong 1 ngày. Cam kết đền tiền X5 nếu phát hiện Fake. Đổi trả miễn phí size. Dịch vụ vệ sinh trọn đời. MUA NGAY!'),
(12, 2, 'Adidas NMD R1 \"Glow Pink\"', 3150000, 'Thân giày co giãn có các chi tiết phủ ngoài bằng TPU trong mờ giúp bảo vệ đôi chân khỏi thời tiết ẩm ướt. Lớp đệm đàn hồi mang đến cảm giác siêu thoải mái cho từng bước chân'),
(13, 2, 'Adidas Monsters Inc. x Stan Smith ‘Mike & Sulley’ GZ5990\"', 3150000, 'Mua Giày Adidas Monsters Inc. x Stan Smith ‘Mike & Sulley’ GZ5990 chính hãng 100% có sẵn tại Authentic Shoes. Giao hàng miễn phí trong 1 ngày. Cam kết đền tiền X5 nếu phát hiện Fake. Đổi trả miễn phí size. FREE vệ sinh giày trọn đời. MUA NGAY!');
...
(19, 2, 'hello', '2024-06-07 10:55:19', 'Đã xử lý'),
(20, 2, 'hihi', '2024-06-07 10:55:24', 'Chưa xử lý');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nhanvien_rep`
--
...
--
-- Đang đổ dữ liệu cho bảng `nhanvien_rep`
--

INSERT INTO `nhanvien_rep` (`id`, `MaMess`, `employee_id`, `response`, `created_at`) VALUES
...
(179, 'Nike Air Force 107 LV8', 1, 1, 1, 50, 'NK01.png'),
...
(189, 'All Star All Terrain', 4, 3, 2, 100, 'CON01.jpg'),
(190, 'All Star All Terrain', 4, 3, 3, 100, 'CON01.jpg'),
(191, 'All Star All Terrain', 4, 3, 4, 100, 'CON01.jpg'),
(192, 'All Star All Terrain', 4, 3, 5, 100, 'CON01.jpg'),
(193, 'Nike Air Max 90 Triple White\'', 2, 1, 1, 20, 'NK02.jpg'),
(194, 'Nike Air Max 90 Triple White\'', 2, 1, 2, 20, 'NK02.jpg'),
(195, 'Nike Air Max 90 Triple White\'', 2, 1, 4, 20, 'NK02.jpg'),
(196, 'Nike Air Max 90 Triple White\'', 2, 1, 5, 20, 'NK02.jpg'),
(197, 'Chuck Taylor All Star City Trek Waterproof Boot', 6, 3, 4, 20, 'CON02.jpg'),
(198, 'Chuck Taylor All Star City Trek Waterproof Boot', 6, 3, 6, 20, 'CON02.jpg'),
(199, 'Chuck Taylor All Star City Trek Waterproof Boot', 6, 3, 1, 10, 'CON02.jpg'),
(200, 'Chuck Taylor All Star City Trek Waterproof Boot', 6, 3, 5, 25, 'CON02.jpg'),
(201, 'Vans Knu-Skool ‘Black White’ VN0009QC6BT', 9, 3, 3, 100, 'VA01.png'),
(202, 'Vans Knu-Skool ‘Black White’ VN0009QC6BT', 9, 3, 1, 100, 'VA01.png'),
(203, 'Converse x DRKSHDW TURBODRK Chuck 70', 10, 3, 3, 20, 'CON03.jpg'),
(204, 'Converse x DRKSHDW TURBODRK Chuck 70', 10, 3, 4, 20, 'CON03.jpg'),
(205, 'Converse x DRKSHDW TURBODRK Chuck 70', 10, 3, 5, 20, 'CON03.jpg'),
(206, 'MLB Chunky Wide Los Angeles ‘Pink’ 3ASXCCW3N-07PKS', 11, 5, 2, 10, 'MLB02.png'),
(207, 'Adidas NMD R1 \"Glow Pink\"', 12, 5, 5, 25, 'AD02.png'),
(208, 'Adidas Monsters Inc. x Stan Smith ‘Mike & Sulley’ GZ5990\"', 13, 5, 1, 20, 'AD03.png');
...
(2, 'Lê Thị E', '09123456788', 'user', '456', 'tgq.20597@gmail.com', '456 GHJ', 'AD01.png', 0),
...
--
-- Chỉ mục cho bảng `nhanvien_rep`
--
ALTER TABLE `nhanvien_rep`
  ADD PRIMARY KEY (`id`),
  ADD KEY `MaMess` (`MaMess`,`employee_id`);
...
--
ALTER TABLE `donhang`
  MODIFY `MaDonHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `loaisanpham`
  MODIFY `MaLoaiSP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `messages`
  MODIFY `MaMess` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `nhanvien_rep`
--
ALTER TABLE `nhanvien_rep`
...
--
ALTER TABLE `sanpham`
  MODIFY `MaSP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_1` FOREIGN KEY (`MaUser`) REFERENCES `user` (`MaUser`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `nhanvien_rep`
--
ALTER TABLE `nhanvien_rep`
  ADD CONSTRAINT `nhanvien_rep_ibfk_1` FOREIGN KEY (`MaMess`) REFERENCES `messages` (`MaMess`) ON DELETE NO ACTION ON UPDATE CASCADE;
